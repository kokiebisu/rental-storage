...
type SpaceService interface {
	...
	CreateSpace(lenderId string, streetAddress string, latitude float64, longitude float64, imageUrls []string, title string, description string) (string, *customerror.CustomError)
