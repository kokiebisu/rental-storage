...
def test_success__user_created():
    ...
    message = SlackUserMessageSenderService.generate_user_account_created_message(first_name=mock_data['first_name'], last_name=mock_data['last_name'], email_address=mock_data['email_address'])
    expected_message = (
