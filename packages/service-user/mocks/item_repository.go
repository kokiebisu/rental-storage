...
func (_m *ItemRepository) FindById(uid string) (item.Entity, *errors.CustomError) {
	ret := _m.Called(uid)

	var r0 item.Entity
	var r1 *errors.CustomError
	if rf, ok := ret.Get(0).(func(string) (item.Entity, *errors.CustomError)); ok {
		return rf(uid)
	}
...
func (_m *ItemRepository) Save(i item.Entity) (string, *errors.CustomError) {
	...
	var r0 string
	var r1 *errors.CustomError
	if rf, ok := ret.Get(0).(func(item.Entity) (string, *errors.CustomError)); ok {
		return rf(i)
	}
